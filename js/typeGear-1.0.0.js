...
/**
 * Open keyboard in normal mode and return result into callback
 * 
 * @param onsuccess -
 *            success input
 * @param onerror -
 ...
 */
function pickText(onsuccess, onerror, oncancelled) {
	pickText("", KeyboardModes.NORMAL, onsuccess, onerror, oncancelled);
}
 ...
 *            user cancelled input
 */
function pickText(text, onsuccess, onerror, oncancelled) {
	pickText(text, onsuccess, onerror, oncancelled);
}
